...
# graph plot for 80-20 workload
plt.scatter(cachesizes, lruHits_8020, marker='x', color='brown', label='LRU')
plt.scatter(cachesizes, fifoHits_8020, marker ='.', color='green', label='FIFO')
plt.plot(cachesizes, lfuHits_8020, color='pink', label='LFU')
plt.plot(cachesizes, randomHits_8020, color='purple', label='Random')
plt.plot(cachesizes, OracleModelHits_8020, color='red', label='OracleModel')
